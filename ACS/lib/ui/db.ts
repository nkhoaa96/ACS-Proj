...
export function query(
  ...
  filter = expression.evaluate(filter, null, Date.now());
  filter = minimize(filter, true);
  // console.log("Query To DB", JSON.stringify(filter))

  // filter = '[ "AND", ["OR", ["LIKE", ["FUNC", "LOWER", ["PARAM", "DeviceID.SerialNumber"]], "%008%"], ["LIKE", ["FUNC", "LOWER", ["PARAM", "DeviceID.ProductClass"]], "%008%"],["LIKE", ["FUNC", "LOWER", ["PARAM", "VirtualParameters.SoftwareVersion"]], "%008%"],["LIKE", ["FUNC", "LOWER", ["PARAM", "VirtualParameters.IPV4Address"]], "%008%"],["LIKE", ["FUNC", "LOWER", ["PARAM", "VirtualParameters.OUI"]], "%008%"],["LIKE", ["FUNC", "LOWER", ["PARAM", "VirtualParameters.SSID24G"]], "%008%"],["LIKE", ["FUNC", "LOWER", ["PARAM", "VirtualParameters.SSID5G"]], "%008%"],["LIKE", ["FUNC", "LOWER", ["PARAM", "VirtualParameters.PPPoEACName"]], "%008%"], ["IS NOT NULL", ["PARAM", "Tags.008"]]],["AND",["<",["PARAM","Events.Registered"],1704992399000],[">",["PARAM","Events.Registered"],1704214800000]]]'
  ...
  //     {
  //       _id: {
  //         $eq: "202BC1-BM632w-000008"
  //       }
  //     },
  //     {
  //       _id: {
  //         $eq: "202BC1-BM632w-000009"
  //       }
  //     },
  //   ]
  // }
